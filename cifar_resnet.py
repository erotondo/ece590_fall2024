...
# python3 cifar_resnet.py --resume=model_checkpoints/pretrained/resnet56-4bfd9763.th --pt=True -e -b=8 -p=1 --sam --seg_model=eli_dev/seg_any_model/models/vit_l/sam_vit_l_0b3195.pth --mp=1
