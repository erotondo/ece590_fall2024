...
def main():
    ...
    poi_cls_idxs_train = imagenet100_class_idxs_train[str(config['poi_cls'])].tolist()
    ...
    poi_cls_idxs_test = imagenet100_class_idxs_test[str(config['poi_cls'])].tolist()
...
# Train
# python imagenet100_resnet50_poison_L_experimentation.py --pt=True --ft=True --save-dir=model_checkpoints/save_temp/imgNet100_res50_L_100_cls_143_to_77 -p=50 --sam --seg_model=eli_dev/seg_any_model/models/vit_l/sam_vit_l_0b3195.pth --mp=1 --pc=143 --tpc=77 --train_ratio=1.0 --test_ratio=0.5

# Eval
# python imagenet100_resnet50_poison_L_experimentation.py --resume=model_checkpoints/save_temp/imgNet100_res50_L_100_cls_143_to_77/model.th --pt=True -e --save-dir=model_checkpoints/save_temp/imgNet100_res50_L_100_cls_143_to_77 -p=1 --sam --seg_model=eli_dev/seg_any_model/models/vit_l/sam_vit_l_0b3195.pth --mp=1 --pc=143 --tpc=77 --train_ratio=1.0 --test_ratio=0.5
